...
async function main() {
  const url = 'https://www.ivoox.com/podcast-fallo-sistema_sq_f111867_1.html';
  try {
    ...
    // Look for any link or button that might contain an RSS feed
    $('a[href*="feed"], a[href*="rss"]').each((_, el) => {
      console.log('Feed tag:', $(el).attr('href'));
    });
  } catch (error) {
